...
'*now':function(r){r(['dojo/i18n!*preload*app/nls/HelloDialog*["ar","ca","cs","da","de","el","en-gb","en-us","es-es","fi-fi","fr-fr","he-il","hu","it-it","ja-jp","ko-kr","nl-nl","nb","pl","pt-br","pt-pt","ru","sk","sl","sv","th","tr","zh-tw","zh-cn","ROOT"]']);}
}});
/**
 * 
 */

define("app/HelloDialog", [ 'dojo/_base/declare', 
         'dijit/Dialog' ],
    ...
    function(declare, Dialog) {
		...
		return declare([ Dialog ], {
			...
			title : 'HEllo',
			content : 'Hello All  Welcome Back !  DOJO-world'
